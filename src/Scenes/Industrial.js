class Industrial extends Phaser.Scene {
    ...
    create() {
        ...
        // Find gas in the "Objects" layer in Phaser
        // Look for them by finding objects with the name "gas"
        // Assign the gas texture from the tilemap_sheet_industrial sprite sheet
        // Phaser docs:
        ...
        // Create a Phaser group out of the array this.gas
