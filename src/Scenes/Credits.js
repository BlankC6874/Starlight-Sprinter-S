class Credits extends Phaser.Scene {
    ...
    create() {
        ...
        this.creditsText = this.add.text(this.cameras.main.centerX, 300, 'Guangyang Chen', { font: '20px Arial', fill: '#ffffff' }).setOrigin(0.5);
        this.creditsText = this.add.text(this.cameras.main.centerX, 350, 'gchen79@ucsc.edu', { font: '20px Arial', fill: '#ffffff' }).setOrigin(0.5);
