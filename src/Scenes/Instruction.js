class Instruction extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(this.cameras.main.centerX, 250, '1. Use arrow keys to control player avatars movement, and press r to restart', { font: '20px Arial', fill: '#ffffff' }).setOrigin(0.5);
        ...
        this.add.text(this.cameras.main.centerX, 450, '5. Be careful with the patrolling enemies, they will deduct your hp. Grant hp by getting the heart', { font: '20px Arial', fill: '#ffffff' }).setOrigin(0.5);
        this.add.text(this.cameras.main.centerX, 500, '6. Enjoy the Game!', { font: '20px Arial', fill: '#ffffff' }).setOrigin(0.5);
